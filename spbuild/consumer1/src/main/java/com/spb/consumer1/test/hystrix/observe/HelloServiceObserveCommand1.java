package com.spb.consumer1.test.hystrix.observe;
...
@Service
public class HelloServiceObserveCommand1 {
            ...
            public void call(Subscriber<? super String> subscriber) {
                try {
                    if (!subscriber.isUnsubscribed()){
                        ...
                        String result1 = restTemplate.getForObject("http://HI/hi?name=" , String.class).toString();
